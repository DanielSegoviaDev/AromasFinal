        ...
        return(
            ...
            <div className="overlay-popup active" id="overlay-popup" >
                <div className="popup active" id="popup">
                    <a href="/#Productos" id="btn-cerrar-popup" className="btn-cerrar-popup"><img src={X} alt="x" onClick={cerrar}/></a>
                    <h2>Hornitos</h2>
